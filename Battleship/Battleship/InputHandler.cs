...
namespace Battleship
{
    class InputHandler
    {
        ...
        public static ShipPlacement GetLocation(string location)
        {
        ...
        public static ShipPlacement GetLocationFromComputer()
        {
            ShipPlacement ShipToPlace = new ShipPlacement();
        ...
        public static Coordinate GetShotLocationFromComputer(Board victimboard, Level gamelevel)
        {
